...
type RevenueService interface {
	...
	UpdateRevenue(id uint, newRevenue *models.CreateRevenueDto) error
}
...
func (s *revenueService) UpdateRevenue(id uint, newRevenue *models.CreateRevenueDto) error {
	revenue := &models.Revenue{
		ID:          id,
...
func (s *revenueService) DeleteRevenue(id uint) error {
